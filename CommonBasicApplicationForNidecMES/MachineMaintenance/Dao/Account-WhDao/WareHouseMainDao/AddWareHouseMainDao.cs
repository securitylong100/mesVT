...
namespace Com.Nidec.Mes.Common.Basic.MachineMaintenance.Dao
{
    class AddWareHouseMainDao : AbstractDataAccessObject
    {
        public override ValueObject Execute(TransactionContext trxContext, ValueObject vo)
        {
            ...
            sql.Append(@"insert into t_warehouse_main(asset_id, qty, unit, account_code_id, account_location_id, rank_id, comment_data, 
            ...
            sql.Append(@"values(:asset_id, :qty,:unit, :account_code_id, :account_location_id, :rank_id, :comment_data, 
                        :depreciation_start, :depreciation_end, :current_depreciation,   :monthly_depreciation, 
                        :accum_depreciation_now, :net_value,  :user_location_id, :before_location_id, :after_location_id,:detail_position_id, :registration_user_cd,:registration_date_time, :factory_cd)");
